<!--
Mostly based on https://agentskills.io/llms-full.txt with minor edits to reflect the current repository and tooling.
-->
...
<CardGroup>
  ...
  <Card title="Reference library" icon="wrench" href="https://pypi.org/project/skills-ref">
...
The [skills-ref](https://pypi.org/project/skills-ref) library provides Python utilities and a CLI for working with skills.
